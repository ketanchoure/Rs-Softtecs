  ...
  const features = [
    {
      ...
      description: "One-on-one guidance from industry experts with 10+ years of experience",
      color: "text-primary"
    },
    {
      icon: Calendar,
      title: "Live Interactive Sessions",
      description: "Real-time learning with doubt clearing and hands-on coding practice",
      color: "text-accent"
    },
    {
      icon: Code,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">
            Why Choose 
            <span className="bg-gradient-primary bg-clip-text text-transparent"> RS Softtecs</span>
          </h2>
