...
const Header = () => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      hasDropdown: true,
      items: [
        { name: "Java Full Stack Development", path: "/course/java-full-stack-development" },
        { name: "Python Full Stack Development", path: "/course/python-full-stack-development" },
        { name: "Cloud Computing", path: "/course/cloud-computing" },
        { name: "Salesforce & Software Testing", path: "/course/salesforce-testing" },
        { name: "Data Analyst", path: "/course/data-analyst" },
      ],
    },
