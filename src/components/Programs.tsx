...
const toolLogos = {
  ...
  // Networking: "https://cdn-icons-png.flaticon.com/512/2260/2260367.png",
...
const courses = [
  ...
  },
  {
    ...
    // description: 'Analyze data and build AI models using Python, SQL, and machine learning techniques.',
  ...
  //   seatsLeft: 3,
  //   title: '.Net',
  //   courseLogo: courseLogos.NET,
  //   // description: 'Build dynamic web applications using Python, Django, and front-end technologies.',
  //   tools: ['Angular','React','MVC','SQL','MySQL'],
  //   tags: ['UNLIMITED INTERVIEWS', 'INTEGRATED INTERNSHIP'],
  // },
  {
    id: 3,
...
const CourseCard = ({ course }) => (
  <div className="w-full max-w-sm h-[75vh] overflow-y-auto bg-white rounded-xl shadow-md border p-4 flex flex-col justify-between relative text-xs">
    {/* Top Right: Seats Left
    <div className="text-red-600 font-semibold absolute top-2 right-2 text-xs">
    ...
    {/* Countdown Timer
    <div className="text-gray-600 text-[11px] text-center mt-1 mb-2">
    </div> */}
